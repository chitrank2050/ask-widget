import"./react-cVVaRz0s.js";import"./jsx-runtime-DQZni8ie.js";import{t as e}from"./ChatPanel-Cyar5Mbc.js";var t={title:`Widget/Sub-components/ChatPanel`,component:e,argTypes:{onInputChange:{action:`inputChanged`},onSubmit:{action:`submitted`},onCollapse:{action:`collapsed`},onReset:{action:`reset`}},parameters:{layout:`centered`},tags:[`autodocs`]},n=[{id:`1`,role:`assistant`,content:`Hello! I am your AI assistant. How can I help you today?`,timestamp:new Date},{id:`2`,role:`user`,content:`What is your name?`,timestamp:new Date},{id:`3`,role:`assistant`,content:`I am the Ask Chitrank widget, a RAG-powered chatbot.`,timestamp:new Date}],r={args:{title:`Ask Chitrank`,messages:n,activeStreamId:null,isStreaming:!1,inputValue:``,placeholder:`Ask me anything...`,latency:.15}},i={args:{...r.args,messages:[...n,{id:`4`,role:`assistant`,content:`I am currently thinking about your question...`,timestamp:new Date}],activeStreamId:`4`,isStreaming:!0,latency:null}},a={args:{...r.args,messages:[]}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    title: 'Ask Chitrank',
